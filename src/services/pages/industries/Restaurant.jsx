        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-tertiary">Built for Scale</span>
            </h1>
            <p className="text-lg md:text-xl opacity-70 leading-relaxed">
              Streamline operations and maximize revenue for your restaurant with intelligent order management, inventory tracking, and customer insights.
            </p>
          ...
          <motion.div className="relative">
            <motion.img
              ...
              src="https://images.unsplash.com/photo-1495549557519-180d5b3fd5d0?w=800&q=80"
