...
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary-container text-xs font-bold uppercase mb-6">
<span className="w-2 h-2 rounded-full bg-tertiary animate-pulse"></span>
Luxury Fashion AI
</div>

<h1 className="text-5xl lg:text-7xl font-extrabold mb-8">
Synckraft <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-tertiary">
Fashion OS
</span>
</h1>

<p className="text-lg max-w-xl mb-10 opacity-80">
Transform your fashion brand with 3D visualization, AI commerce,
and intelligent growth automation.
</p>
...
src="https://images.unsplash.com/photo-1520975922284-6f12b2db3e54"
...
title:"3D Garments",
icon:"view_in_ar",
desc:"Photorealistic garment rendering"
},
{
title:"Virtual Try On",
icon:"accessibility_new",
desc:"AR clothing preview"
},
{
title:"AI Catalog",
icon:"inventory",
desc:"Smart catalog generation"
}
].map((item,i)=>(
