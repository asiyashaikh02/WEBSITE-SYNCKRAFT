        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-tertiary">Reimagined</span> for Growth
            </h1>
            <p className="text-lg md:text-xl opacity-70 leading-relaxed">
              Transform your retail operations with intelligent automation, inventory management, and customer experience optimization.
            </p>
          ...
          <motion.div className="relative">
            <motion.img
              ...
              src="https://images.unsplash.com/photo-1554224311-beee415c15ae?w=800&q=80"
