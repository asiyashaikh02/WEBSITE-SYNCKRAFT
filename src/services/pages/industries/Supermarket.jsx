      ...
      <section className="max-w-screen-2xl mx-auto px-4 md:px-8 py-16 md:py-32 mb-20 md:mb-32">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <motion.div initial="hidden" animate="visible" variants={animationVariants.fadeInUp} className="space-y-4 md:space-y-8">
            <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full bg-primary/10 border border-primary/20"><span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>Supermarket Operating System</div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold"><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-tertiary">Optimized</span></h1>
            <p className="text-lg md:text-xl opacity-70">Eliminate waste and maximize inventory efficiency at scale.</p>
          ...
          <motion.div initial="hidden" animate="visible" variants={animationVariants.fadeInScale} className="relative h-64">
            <motion.img animate={{ y: [0, -20, 0] }} src="https://images.unsplash.com/photo-1599972291473-c90be2b54a5f?w=800&q=80" className="w-full h-full object-cover rounded-3xl"/>
          </motion.div>
        </div>
      </section>
    </main>
