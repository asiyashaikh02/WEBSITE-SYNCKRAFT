      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="reveal">
            <span className="text-blue-600 font-bold uppercase tracking-widest text-[10px] mb-6 inline-block px-4 py-1.5 rounded-full border border-blue-100 bg-blue-50/50">
              About Synckraft
            </span>
            ...
            <div className="grid sm:grid-cols-2 gap-8">
               <div className="group">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 transition-all duration-300 bg-blue-50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-blue-600/20">
                    <Cpu size={24} />
                  </div>
          ...
          <div className="relative reveal lg:pl-12">
            <div className="aspect-square rounded-3xl overflow-hidden flex items-center justify-center relative group bg-slate-50 border border-slate-100 transition-all hover:border-blue-200">
              ...
              <div className="relative z-10 p-10 text-center">
                 <div className="w-20 h-20 rounded-2xl bg-blue-600 flex items-center justify-center mx-auto mb-8 shadow-xl shadow-blue-600/20">
            ...
            {/* Visual Accents */}
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-blue-50/80 blur-3xl rounded-full -z-10" />
          </div>
        </div>
      </div>
    </section>
